...
Quick shortcut reference. Each row links to a full guide under
...
2. Write (or add to) a matching guide file under `Examples/` — one file per
   shortcut or workflow, following the shape of the existing ones (Shortcut
   table, Steps, any Known issues).
